# Exercise 4: what the rule loses when the list must arrive at 120 days, not 90.
import sqlite3
...
print("Days-since rule, top 40 a cohort, renewals ending 2023 to mid-2024")
for lead in (90, 120):
    ...
    top = (renewals.sort_values(["moment", "days_since_order", "contract_id"],
                                ascending=[True, False, True], na_position="last")
           .groupby("moment").head(40))
    print(f"  scored {lead:>3} days out   precision {top.left_.mean():.1%}"
